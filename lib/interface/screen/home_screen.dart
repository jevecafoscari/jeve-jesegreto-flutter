...
import 'package:jeve_jesegreto_flutter/resources/provider/file_provider.dart';
          ...
          builder: (BuildContext context) {
            ...
            return StatefulBuilder(builder: (BuildContext context, dialogState) {
              return AlertDialog(
                ...
                actions: [
                  TextButton(
                    child: Text(attachment == null ? "Aggiungi immagine" : "Rimuovi immagine"),
                    onPressed: () async {
                      if (attachment == null) {
                        attachment = await FileProvider.getImageFile();
                      } else {
                        attachment = null;
                      }
